...
// randomized_ncl
Rcpp::List randomized_ncl(Eigen::VectorXd theta, Eigen::MatrixXd data, Eigen::MatrixXd X, bool printFLAG, const double PROB, const int PAIRS_RANGE, const int STRUCT);
RcppExport SEXP _gammaFrailty_randomized_ncl(SEXP thetaSEXP, SEXP dataSEXP, SEXP XSEXP, SEXP printFLAGSEXP, SEXP PROBSEXP, SEXP PAIRS_RANGESEXP, SEXP STRUCTSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::VectorXd >::type theta(thetaSEXP);
    ...
    Rcpp::traits::input_parameter< const int >::type PAIRS_RANGE(PAIRS_RANGESEXP);
    Rcpp::traits::input_parameter< const int >::type STRUCT(STRUCTSEXP);
    rcpp_result_gen = Rcpp::wrap(randomized_ncl(theta, data, X, printFLAG, PROB, PAIRS_RANGE, STRUCT));
    return rcpp_result_gen;
END_RCPP
}
// gammaFrailty2
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_gammaFrailty_randomized_ncl", (DL_FUNC) &_gammaFrailty_randomized_ncl, 7},
